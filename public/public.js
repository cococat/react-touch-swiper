...
/******/ 	__webpack_require__.p = "http://localhost:3000/myproject/react-touch-swiper/public";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Touchswipe = __webpack_require__(162);
	a = ReactDOM.render(React.createElement(
				Touchswipe,
				{ interval: '3000', height: '250px' },
				React.createElement(
							'span',
							{ style: { display: "inline-block", background: "black", color: "#fff", width: "100%", height: "100%" } },
							'1'
				),
				React.createElement(
							'span',
							{ style: { display: "inline-block", background: "red", color: "yellow", width: "100%", height: "100%" } },
							'2'
				),
				React.createElement(
							'span',
							{ style: { display: "inline-block", background: "green", color: "blue", width: "100%", height: "100%" } },
							'3'
				),
				React.createElement(
							'span',
							{ style: { display: "inline-block", background: "pink", color: "#fff", width: "100%", height: "100%" } },
							'4'
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ReactDOM"] = __webpack_require__(161);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
	...
	Touchswipe = (function () {
		...
		var animate = {
			getNow: function () {
				...
				if (now > data.config.length) {
					now = 1;
				}
				if (data.x < 0) {
					now = data.config.length;
				}
				return now;
			},
			...
			start: function () {
				//console.log("start");
				var me = this;
				var interval = Number(data.config.interval) + Number(data.config.speed),
				    initInterval;
				animate.stop.call(this);
				if (data._initState) {
					data._initState = false;
		...
		return React.createClass({
			...
			render: function () {
				...
				return React.createElement(
					"div",
					{ className: "touchswipe" },
					React.createElement(
						"div",
						{ className: "touchswipe-main",
						...
						React.createElement(
							"div",
							{ className: "touchswipe-body", ref: "touchswipe", style: {
							...
							React.Children.map(this.props.children, (function (child) {
								...
								return React.createElement(
									"div",
									{ className: "touchswipe-box", "data-b-id": data._num1 },
									child
								);
							}).bind(this)),
							React.Children.map(this.props.children, (function (child) {
					...
					React.createElement(
						...
						React.Children.map(this.props.children, (function (child) {
							...
							return React.createElement("div", { className: className, "data-b-id": data._num2, onTouchEnd: buttonClick.bind(this) });
						}).bind(this))
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./node_modules/css-loader/index.js!./touchswipe.css", function() {
				var newContent = require("!!./node_modules/css-loader/index.js!./touchswipe.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".touchswipe{\n\tposition: relative;\n\twidth: 100%;\n}\n.touchswipe-main{\n\twidth: 100%;\n\tbox-sizing:border-box;\n\t-webkit-transform: transition3d(0,0,0);\n\toverflow: hidden;\n\tz-index: 0;\n}\n.touchswipe-body{\n\t\theight: 200px;\n\tdisplay: -webkit-box;\n\twidth: 100%;\n}\n.touchswipe-box{\n\twidth: 100%;\n\theight: inherit;\n}\n.touchswipe-op{\n\tposition: absolute;\n\tdisplay: -webkit-box;\n\tbottom: 10px;\n\tleft: 50%;\n\tz-index: 1;\n\t-webkit-transform: translateX(-50%);\n}\n.touchswipe-button{\n\twidth: 10px;\n\theight: 10px;\n\t-webkit-box-flex:1;\n\tborder-radius: 10px;\n\tbackground: #000;\n\tmargin: 5px;\n}\n.touchswipe-button-cur{\n\tbackground:#fff;\n}\n", ""]);
